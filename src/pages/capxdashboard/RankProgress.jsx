...
<div className="flex items-center justify-between bg-gray-100 rounded-lg shadow p-4 border border-gray-200 w-full relative">
      ...
      <div className="flex items-center gap-2">
        <FaSpider className="text-purple-800 text-3xl" />
      ...
      <div className="flex items-center gap-2">
        <span className="bg-blue-800 text-white p-1 px-3 rounded-md text-lg font-bold">
          2
        </span>
        ...
        <FaBug className="text-purple-800 text-3xl" />
      </div>
    </div>    )
}
