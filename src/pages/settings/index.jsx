  ...
  return (
    <Layout>
      <div className="min-h-screen max-w-4xl mx-auto w-full rounded-xl sm:px-4 px-2 sm:py-6 py-4">
        {/* Profile Card */}
        <div className="bg-white dark:bg-zinc-800 dark:text-white shadow-md rounded-t-xl py-6 px-10 flex max-md:flex-col lg:gap-10 md:gap-8 sm:gap-6 gap-2   md:justify-start items-center justify-center">
         
            <div className="relative  sm:w-24 w-20 h-20  sm:h-24 flex justify-center items-center">
              <img
                src={
                  user?.profile_image
                    ? user.profile_image
                ...
                alt="User"
                className=" sm:w-24 w-20 h-20  sm:h-24 rounded-full border-[4px] border-violet-500"
              />
              <input
                type="file"
                ref={fileInputRef}
              ...
              />
              <div
                className="absolute top-2 -right-2 cursor-pointer bg-violet-500 p-1 rounded-full text-white"
          ...
          <div className="flex flex-col md:items-start md:text-left max-md:items-center max-md:text-center gap-1">
            <h2 className="  text-2xl font-semibold capitalize italic">
              {user?.fullname}
            </h2>
            <p className=" sm:text-lg text-base  text-zinc-800 dark:text-zinc-100 font-semibold">
              @{user?.username}
            </p>
            <div className="flex mt-2 items-center gap-4 text-[#7A44FF]">
              <FaInstagram size={24} />
              <FaFacebook size={24} />
        ...
        <div>
          ...
          <div className="md:hidden shadow-lg bg-[#7A44FF] text-white px-4 py-2 rounded-b-xl">
            ...
            >
              {filteredTabs.map((tab) => (
                <option key={tab} value={tab} className="bg-white text-black">
                  {tab}
                </option>
              ))}
            </select>
