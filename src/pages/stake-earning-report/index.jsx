...
const StakeEarningReport = () => {
  ...
  const filteredData = mockStakeEarnings.filter((item) => {
    const matchesSearch =
          ...
          <table className="w-full text-left text-sm sm:text-base border-collapse">
            <thead className="bg-[#F6EEFE] text-purple-500 whitespace-nowrap font-medium text-sm">
              <tr>
                ...
                <th className="p-4 whitespace-nowrap">Cliff</th>
                <th className="p-4 whitespace-nowrap">Vesting</th>
              ...
              {paginatedData.length > 0 ? (
                paginatedData.map((item, idx) => (
                  ...
                  >
                    ...
                    <td className="p-2 sm:p-4">{item.cycle}</td>
                    <td className="p-2 sm:p-4">{item.cliff}</td>
                    <td className="p-2 sm:p-4">{item.vesting}</td>
...
export default StakeEarningReport; 