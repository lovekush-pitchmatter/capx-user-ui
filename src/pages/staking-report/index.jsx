...
const mockStaking = [
  {
    ...
    transactionId: "6333963268",
    amount: 200.0,
    currency: "BTC",
    details: "Staking Rewards on Staking ID 67676767",
    status: "Confirmed",
  },
  // ... more rows as needed
];
...
const StakingReport = () => {
  ...
  const filteredData = mockStaking.filter((item) => {
    const matchesSearch =
              ...
              {paginatedData.length > 0 ? (
                paginatedData.map((item, idx) => (
                  ...
                  >
                    ...
                    <td className="p-2 sm:p-4">{item.details}</td>
                    <td className="p-2 sm:p-4 text-center">
                      <button className="text-[#7A44FF] hover:text-[#B500EF] p-2 rounded-full">
                        <LuEye size={20} />
                      </button>
                    </td>
                  </tr>
