...
const mockConversions = [
  {
    ...
    transactionId: "2345634219",
    details: "[Statement][Narration]\n[Transaction ID]",
    pair: "USDT-BTC",
    paidAmount: "56.00 USDT",
    receivedAmount: "56.00 BTC",
    status: "Confirmed",
  },
  {
    date: "27-Jul-2024 14:14:29",
...
const ConversionsReport = () => {
  ...
  const filteredData = mockConversions.filter((item) => {
    const matchesSearch =
          ...
          <table className="w-full text-left text-sm sm:text-base border-collapse">
            <thead className="bg-[#F6EEFE] text-purple-500 whitespace-nowrap font-medium text-sm">
              <tr>
                ...
                <th className="p-4 whitespace-nowrap">Pair</th>
                <th className="p-4 whitespace-nowrap">Paid Amount</th>
                <th className="p-4 whitespace-nowrap">Received Amount</th>
              </tr>
            </thead>
            <tbody>
              {paginatedData.length > 0 ? (
                paginatedData.map((item, idx) => (
                  ...
                  >
                    ...
                    <td className="p-2 sm:p-4">{item.pair}</td>
                    <td className="p-2 sm:p-4">{item.paidAmount}</td>
                    <td className="p-2 sm:p-4">{item.receivedAmount}</td>
                  </tr>
                ))
              ) : (
                <tr>
